// Shader_QuakeSkybox.shader
// From: https://github.com/selewi/quake-skybox-shader-unity/blob/master/Assets/Shader_QuakeSkybox.shader
/**
...
Shader "Retro/QuakeSkybox"
{
	Properties
	{
		...
		_CutOff("Cutoff", Range(0, 1)) = 0.025 // PMC: was 0

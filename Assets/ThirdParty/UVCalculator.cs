// UVCalculator.cs
// from: https://answers.unity.com/questions/64410/generating-uvs-for-a-scripted-mesh.html
...
public class UVCalculator
{
	...
	{
		var ret = Facing.Up;
		float maxDot = 0; // supposed bug fix -- Mathf.NegativeInfinity;

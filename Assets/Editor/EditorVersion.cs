// EditorVersion.cs
// Code to help manage which version of Unity we're using in this project
...
public class EditorVersion {
	...
	static EditorVersion()
	{
		...
		if (loadedLevelName == "")
		{
	        Debug.LogWarning("No scene name detected -- you may be in an unsaved level/scene. This message can appear more than once.");
		}
